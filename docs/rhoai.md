...
3) Access the `workbench` named `apr7-chatbot-bringyourown-notebook`.
...
5) In the terminal, run `cd apr7-chatbot-bringyourown` to navigate to your sample app's directory.
